...
Rails.configuration.to_prepare do
  ...
  "Please accept this electronic request for public records made under OPRA and the common law right of access.  I am not required to fill out an official form or use a particular software platform to submit my request per N.J.S. 47:1A-5(f), which states that an email from a requestor including all of the information required on the adopted form shall suffice in place of a completed form as a valid government record request.
